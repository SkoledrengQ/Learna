        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_FileResource_ExactlyOneTarget", "(`SubjectGroupId` IS NULL) <> (`LessonId` IS NULL)");
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_FileResources_SubjectGroups_SubjectGroupId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FileResources_SubjectGroupId",
                table: "FileResources",
